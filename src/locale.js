export default {
    ko: {
        ...
        koreanbots: "국내 디스코드 봇들을 한 곳에서 확인하세요.",
        phonepare: "간단하게 다양한 제조사의 핸드폰의 스펙을 비교하세요.",
        ...
        koreanbotsIntro: '국내 디스코드봇을 한 곳에서.',
        koreanbotsDesc: '관리부터 게임봇까지. 국내의 모든 디스코드 봇을 해당 사이트에서 확인할 수 있습니다.',
        phonepareIntro: '핸드폰끼리 비교하기.',
        phonepareDesc: '서로 다른 회사의 핸드폰을 비교합니다.',
        contact: '연락하기',
    ...
    en: {
        ...
        koreanbots: "Check Koreanbots in one place.",
        phonepare: "Simply Compare Phones.",
        ...
        koreanbotsIntro: 'Koreanbots in ONE place.',
        koreanbotsDesc: 'Moderating to GameBot. Check Every Koreanbots in this website.',
        phonepareIntro: 'Compare Phones.',
        phonepareDesc: 'Compare phones from different companies.',
        contact: 'Contact',
